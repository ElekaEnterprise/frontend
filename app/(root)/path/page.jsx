    ...
    <div className="py-20">
      <div className="w-4/6 mx-auto">
        ...
        <div className="mb-10 bg-[#16213b] p-10 rounded-2xl shadow-xl">
          ...
          <p className="w-5/6 mb-6">Eleka&lsquo;s AI-driven career transition system helps you pivot from one career path to another by analyzing your existing strengths, skills, and experiences. Whether you&lsquo;re shifting from education to tech or from accounting to design, etc., our AI will generate a customized roadmap to guide your journey.</p>
          <Link href="/form" className="border border-[#7C72FF] py-2 px-12 text-xl rounded-full text-white">Start Now</Link>
        </div>
      </div>
    </div>
