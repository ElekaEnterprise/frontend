...
const Features = [
  ...
  },
  {
    ...
    detail: "Planning a change? We&lsquo;ll help you navigate the path with confidence, highlighting the skills and certifications you need."
  },
  {
    ...
    <div>
      ...
      <main className="p-24  overflow-hidden">
        ...
        <div className='my-28 bg-gradient02 border-[#5a5a5a9d] py-20 px-28 border-[1px] rounded-[2rem]'>
          <h1 className='text-xl'><span className='text-[#3FB950] font-extrabold text-4xl'>Why Eleka?</span> is your personal career coach, offering customized guidance whether you&lsquo;re aiming to grow in your current field or planning a complete career transition.</h1>
          <div className='flex gap-4 flex-wrap pt-20'>
            {Features.map((itm) => (
              <div key={itm.key} className='border-[#5a5a5a9d] p-6 border-[1px] rounded-md w-[32%] h-[10rem]'>
